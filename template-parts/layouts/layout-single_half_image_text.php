...
$image_position_setter = get_sub_field('image_position_setter');
...
<div class="essay-layout single-half-image-text card padding <?php echo $image_position_setter ? 'image-right' : 'image-left'; ?>">
